...
;配置tabbar----------------------------------------------------------------------
;;tabbar-ruler
(add-to-list 'load-path "~/list-lisp/")
(require 'tabbar)
...
(setq tabbar-buffer-groups-function nil);不分组
